...
from mkdocs.structure.pages import _RelativePathExtension
    ...
    def on_pre_page(self, page, config, files):
        ...
        if self.should_include(page.file):
            ...
            def new_render(self, config, files):
                ...
                self.content = body
                toc, title = get_nb_toc(page.file.abs_src_path, extensions, extension_configs)
                self.toc = toc
...
def get_nb_toc(fpath, extensions, extension_configs):
